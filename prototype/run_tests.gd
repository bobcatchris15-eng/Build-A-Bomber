...
const GOLDEN_LOCOMOTION_LAYOUT := {
	"small": {
		"wheels": {"hull_y": 0.6320, "stations": [[Vector3(-1.1500, -0.3000, -1.0500), Vector3(0.4970, 0.4970, 0.4970)], [Vector3(-1.1500, -0.3000, 1.0500), Vector3(0.4970, 0.4970, 0.4970)], [Vector3(1.1500, -0.3000, -1.0500), Vector3(0.4970, 0.4970, 0.4970)], [Vector3(1.1500, -0.3000, 1.0500), Vector3(0.4970, 0.4970, 0.4970)]]},
		"tracked_treads": {"hull_y": 0.8660, "stations": [[Vector3(-0.9500, -0.5000, 0.0000), Vector3(1.0000, 1.0000, 1.0000)], [Vector3(0.9500, -0.5000, 0.0000), Vector3(1.0000, 1.0000, 1.0000)]]},
		"legs": {"hull_y": 1.3035, "stations": [[Vector3(-0.9500, -1.1700, -1.0500), Vector3(0.5081, 0.3048, 0.5081)], [Vector3(-0.9500, -1.1700, 1.0500), Vector3(0.5081, 0.3048, 0.5081)], [Vector3(0.9500, -1.1700, -1.0500), Vector3(0.5081, 0.3048, 0.5081)], [Vector3(0.9500, -1.1700, 1.0500), Vector3(0.5081, 0.3048, 0.5081)]]},
	...
	"reference": {
		"wheels": {"hull_y": 0.9882, "stations": [[Vector3(-2.1500, -0.5000, -2.1000), Vector3(0.7309, 0.7309, 0.7309)], [Vector3(-2.1500, -0.5000, 2.1000), Vector3(0.7309, 0.7309, 0.7309)], [Vector3(2.1500, -0.5000, -2.1000), Vector3(0.7309, 0.7309, 0.7309)], [Vector3(2.1500, -0.5000, 2.1000), Vector3(0.7309, 0.7309, 0.7309)]]},
		"tracked_treads": {"hull_y": 1.2002, "stations": [[Vector3(-1.9000, -0.7500, 0.0000), Vector3(1.0000, 1.0000, 1.0000)], [Vector3(1.9000, -0.7500, 0.0000), Vector3(1.0000, 1.0000, 1.0000)]]},
		"legs": {"hull_y": 1.6889, "stations": [[Vector3(-1.9000, -1.4500, -2.1000), Vector3(0.5454, 0.5454, 0.5454)], [Vector3(-1.9000, -1.4500, 2.1000), Vector3(0.5454, 0.5454, 0.5454)], [Vector3(1.9000, -1.4500, -2.1000), Vector3(0.5454, 0.5454, 0.5454)], [Vector3(1.9000, -1.4500, 2.1000), Vector3(0.5454, 0.5454, 0.5454)]]},
	...
	"large": {
		"wheels": {"hull_y": 1.7000, "stations": [[Vector3(-3.6500, -1.1000, -3.8500), Vector3(0.8634, 0.8634, 0.8634)], [Vector3(-3.6500, -1.1000, 3.8500), Vector3(0.8634, 0.8634, 0.8634)], [Vector3(3.6500, -1.1000, -3.8500), Vector3(0.8634, 0.8634, 0.8634)], [Vector3(3.6500, -1.1000, 3.8500), Vector3(0.8634, 0.8634, 0.8634)]]},
		"tracked_treads": {"hull_y": 2.3253, "stations": [[Vector3(-3.3250, -1.5000, 0.0000), Vector3(1.0000, 1.0000, 1.0000)], [Vector3(3.3250, -1.5000, 0.0000), Vector3(1.0000, 1.0000, 1.0000)]]},
		"legs": {"hull_y": 2.6945, "stations": [[Vector3(-3.3250, -2.1500, -3.8500), Vector3(0.5651, 1.2432, 0.5651)], [Vector3(-3.3250, -2.1500, 3.8500), Vector3(0.5651, 1.2432, 0.5651)], [Vector3(3.3250, -2.1500, -3.8500), Vector3(0.5651, 1.2432, 0.5651)], [Vector3(3.3250, -2.1500, 3.8500), Vector3(0.5651, 1.2432, 0.5651)]]},
