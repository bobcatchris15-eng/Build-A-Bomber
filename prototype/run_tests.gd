...
const GOLDEN_LOCOMOTION_LAYOUT := {
	"small": {
		"wheels": {"hull_y": 0.5400, "stations": [[Vector3(-1.1500, -0.3000, -1.0500), Vector3(0.3500, 0.3500, 0.3500)], [Vector3(-1.1500, -0.3000, 1.0500), Vector3(0.3500, 0.3500, 0.3500)], [Vector3(1.1500, -0.3000, -1.0500), Vector3(0.3500, 0.3500, 0.3500)], [Vector3(1.1500, -0.3000, 1.0500), Vector3(0.3500, 0.3500, 0.3500)]]},
		"tracked_treads": {"hull_y": 0.7800, "stations": [[Vector3(-0.9500, -0.5000, 0.0000), Vector3(1.0000, 1.0000, 1.0000)], [Vector3(0.9500, -0.5000, 0.0000), Vector3(1.0000, 1.0000, 1.0000)]]},
		"legs": {"hull_y": 1.2194, "stations": [[Vector3(-0.9500, -1.1700, -1.0500), Vector3(0.5081, 0.3048, 0.5081)], [Vector3(-0.9500, -1.1700, 1.0500), Vector3(0.5081, 0.3048, 0.5081)], [Vector3(0.9500, -1.1700, -1.0500), Vector3(0.5081, 0.3048, 0.5081)], [Vector3(0.9500, -1.1700, 1.0500), Vector3(0.5081, 0.3048, 0.5081)]]},
	...
	"reference": {
		"wheels": {"hull_y": 1.0157, "stations": [[Vector3(-2.1500, -0.5000, -2.1000), Vector3(0.7721, 0.7721, 0.7721)], [Vector3(-2.1500, -0.5000, 2.1000), Vector3(0.7721, 0.7721, 0.7721)], [Vector3(2.1500, -0.5000, -2.1000), Vector3(0.7721, 0.7721, 0.7721)], [Vector3(2.1500, -0.5000, 2.1000), Vector3(0.7721, 0.7721, 0.7721)]]},
		"tracked_treads": {"hull_y": 1.3100, "stations": [[Vector3(-1.9000, -0.7500, 0.0000), Vector3(1.0000, 1.0000, 1.0000)], [Vector3(1.9000, -0.7500, 0.0000), Vector3(1.0000, 1.0000, 1.0000)]]},
		"legs": {"hull_y": 1.5382, "stations": [[Vector3(-1.9000, -1.4500, -2.1000), Vector3(0.5454, 0.5454, 0.5454)], [Vector3(-1.9000, -1.4500, 2.1000), Vector3(0.5454, 0.5454, 0.5454)], [Vector3(1.9000, -1.4500, -2.1000), Vector3(0.5454, 0.5454, 0.5454)], [Vector3(1.9000, -1.4500, 2.1000), Vector3(0.5454, 0.5454, 0.5454)]]},
	...
	"large": {
		...
		"tracked_treads": {"hull_y": 2.5267, "stations": [[Vector3(-3.3250, -1.5000, 0.0000), Vector3(1.0000, 1.0000, 1.0000)], [Vector3(3.3250, -1.5000, 0.0000), Vector3(1.0000, 1.0000, 1.0000)]]},
		"legs": {"hull_y": 2.3435, "stations": [[Vector3(-3.3250, -2.1500, -3.8500), Vector3(0.5651, 1.2432, 0.5651)], [Vector3(-3.3250, -2.1500, 3.8500), Vector3(0.5651, 1.2432, 0.5651)], [Vector3(3.3250, -2.1500, -3.8500), Vector3(0.5651, 1.2432, 0.5651)], [Vector3(3.3250, -2.1500, 3.8500), Vector3(0.5651, 1.2432, 0.5651)]]},
