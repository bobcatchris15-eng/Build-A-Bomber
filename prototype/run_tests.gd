...
const GOLDEN_LOCOMOTION_LAYOUT := {
	"small": {
		...
		"tracked_treads": {"hull_y": 0.4886, "stations": [[Vector3(-1.0000, -0.5000, 0.0000), Vector3(1.0000, 1.0000, 1.0000)], [Vector3(1.0000, -0.5000, 0.0000), Vector3(1.0000, 1.0000, 1.0000)]]},
	...
	"reference": {
		...
		"tracked_treads": {"hull_y": 0.7272, "stations": [[Vector3(-2.0000, -0.7500, 0.0000), Vector3(1.0000, 1.0000, 1.0000)], [Vector3(2.0000, -0.7500, 0.0000), Vector3(1.0000, 1.0000, 1.0000)]]},
	...
	"large": {
		...
		"tracked_treads": {"hull_y": 1.4582, "stations": [[Vector3(-3.5000, -1.5000, 0.0000), Vector3(1.0000, 1.0000, 1.0000)], [Vector3(3.5000, -1.5000, 0.0000), Vector3(1.0000, 1.0000, 1.0000)]]},
