...
const GOLDEN_LOCOMOTION_LAYOUT := {
	...
	"large": {
		...
		"tracked_treads": {"hull_y": 1.8660, "stations": [[Vector3(-3.3250, -1.5000, 0.0000), Vector3(1.0000, 1.0000, 1.0000)], [Vector3(3.3250, -1.5000, 0.0000), Vector3(1.0000, 1.0000, 1.0000)]]},
