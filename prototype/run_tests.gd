...
const GOLDEN_LOCOMOTION_LAYOUT := {
	"small": {
		"wheels": {"hull_y": 0.7801, "stations": [[Vector3(-1.1500, -0.3000, -1.0500), Vector3(0.7187, 0.7187, 0.7187)], [Vector3(-1.1500, -0.3000, 1.0500), Vector3(0.7187, 0.7187, 0.7187)], [Vector3(1.1500, -0.3000, -1.0500), Vector3(0.7187, 0.7187, 0.7187)], [Vector3(1.1500, -0.3000, 1.0500), Vector3(0.7187, 0.7187, 0.7187)]]},
