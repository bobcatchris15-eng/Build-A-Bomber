...
const GOLDEN_LOCOMOTION_LAYOUT := {
	"small": {
		...
		"tracked_treads": {"hull_y": 0.5400, "stations": [[Vector3(-0.9500, -0.5000, 0.0000), Vector3(1.0000, 1.0000, 1.0000)], [Vector3(0.9500, -0.5000, 0.0000), Vector3(1.0000, 1.0000, 1.0000)]]},
	...
	"reference": {
		...
		"tracked_treads": {"hull_y": 0.9000, "stations": [[Vector3(-1.9000, -0.7500, 0.0000), Vector3(1.0000, 1.0000, 1.0000)], [Vector3(1.9000, -0.7500, 0.0000), Vector3(1.0000, 1.0000, 1.0000)]]},
	...
	"large": {
		...
		"tracked_treads": {"hull_y": 1.7000, "stations": [[Vector3(-3.3250, -1.5000, 0.0000), Vector3(1.0000, 1.0000, 1.0000)], [Vector3(3.3250, -1.5000, 0.0000), Vector3(1.0000, 1.0000, 1.0000)]]},
