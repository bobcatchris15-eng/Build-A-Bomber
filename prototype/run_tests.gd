...
const GOLDEN_LOCOMOTION_LAYOUT := {
	...
	"reference": {
		...
		"tracked_treads": {"hull_y": 1.1160, "stations": [[Vector3(-1.9000, -0.7500, 0.0000), Vector3(1.0000, 1.0000, 1.0000)], [Vector3(1.9000, -0.7500, 0.0000), Vector3(1.0000, 1.0000, 1.0000)]]},
	...
	"large": {
		...
		"tracked_treads": {"hull_y": 2.1448, "stations": [[Vector3(-3.3250, -1.5000, 0.0000), Vector3(1.0000, 1.0000, 1.0000)], [Vector3(3.3250, -1.5000, 0.0000), Vector3(1.0000, 1.0000, 1.0000)]]},
