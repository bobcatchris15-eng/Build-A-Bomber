...
const FACTIONS = {
	"industrialists": {
		...
		"base_color": Color(0.58, 0.56, 0.52), "accent_color": Color(0.95, 0.72, 0.06), "detail_color": Color(0.65, 0.40, 0.12),
	...
	"technocrats": {
		...
		"base_color": Color(0.88, 0.92, 0.97), "accent_color": Color(0.02, 0.72, 1.0), "detail_color": Color(0.85, 0.87, 0.9),
		"metallic": 0.5, "anisotropy": 0.7, "brush_scale": 2.5,
		"wear_amount": 0.08, "wear_color": Color(0.7, 0.72, 0.75), "grime_amount": 0.03,
		"edge_highlight_strength": 0.3, "emissive_color": Color(0.0, 0.65, 1.0), "emissive_strength": 0.8,
		"vision_mult": 1.15, "speed_mult": 1.05,
	},
	"expansionists": {
		"name": "Expansionists",
		"passive_summary": "Static buildings exempt from Energy upkeep + slow HQ trickle",
		"base_color": Color(0.38, 0.42, 0.18), "accent_color": Color(0.62, 0.32, 0.10), "detail_color": Color(0.6, 0.5, 0.25),
	...
	"salvage_union": {
		...
		"base_color": Color(0.42, 0.40, 0.36), "accent_color": Color(0.38, 0.35, 0.28), "detail_color": Color(0.80, 0.76, 0.66),
	...
	"crimson_concordat": {
		...
		"base_color": Color(0.60, 0.0, 0.02), "accent_color": Color(0.85, 0.62, 0.08), "detail_color": Color(0.08, 0.08, 0.08),
		"metallic": 0.55, "anisotropy": 0.4, "brush_scale": 2.0,
		"wear_amount": 0.1, "wear_color": Color(0.2, 0.05, 0.05), "grime_amount": 0.05,
		"edge_highlight_strength": 0.35, "emissive_color": Color(0.85, 0.62, 0.08), "emissive_strength": 0.3,
		"low_hp_dps_bonus_max": 0.5,
	},
	"glacier_syndicate": {
		"name": "The Glacier Syndicate",
		"passive_summary": "Reduced terrain speed penalties",
		"base_color": Color(0.88, 0.92, 0.95), "accent_color": Color(0.28, 0.72, 0.98), "detail_color": Color(0.45, 0.50, 0.55),
	...
	"dune_runners": {
		...
		"base_color": Color(0.74, 0.58, 0.28), "accent_color": Color(0.12, 0.62, 0.62), "detail_color": Color(0.4, 0.3, 0.2),
	...
	"ledger_combine": {
		...
		"base_color": Color(0.08, 0.26, 0.62), "accent_color": Color(0.92, 0.93, 0.96), "detail_color": Color(0.12, 0.95, 0.30),
		"metallic": 0.65, "anisotropy": 0.6, "brush_scale": 2.6,
		"wear_amount": 0.05, "wear_color": Color(0.6, 0.62, 0.65), "grime_amount": 0.03,
		"edge_highlight_strength": 0.3, "emissive_color": Color(0.12, 0.95, 0.30), "emissive_strength": 0.4,
		"build_time_mult": 0.85,
	},
	"bayou_irregulars": {
		"name": "The Bayou Irregulars",
		"passive_summary": "Harder for enemies to spot",
		"base_color": Color(0.28, 0.36, 0.14), "accent_color": Color(0.36, 0.26, 0.10), "detail_color": Color(0.4, 0.42, 0.3),
	...
	"aerodrome_cartel": {
		...
		"base_color": Color(0.92, 0.88, 0.78), "accent_color": Color(0.80, 0.48, 0.08), "detail_color": Color(0.06, 0.16, 0.55),
